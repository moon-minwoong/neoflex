...
class iphone_base: UIViewController{
    ...
    func userdefault_show(device_num:Int) {
        print("device name : \(UserDefaults.standard.string(forKey: "dev"+String(device_num)))")
        print("device password : \(UserDefaults.standard.string(forKey: "dev"+String(device_num)+"password"))")
        print("device mode : \(UserDefaults.standard.integer(forKey: "dev"+String(device_num)+"mode"))")
        print("device client3 : \(UserDefaults.standard.string(forKey: "dev"+String(device_num)+"client3"))")
        print("device client4 : \(UserDefaults.standard.string(forKey: "dev"+String(device_num)+"client4"))")
        print("device client5 : \(UserDefaults.standard.string(forKey: "dev"+String(device_num)+"client5"))")
        print("device master : \(UserDefaults.standard.string(forKey: "dev"+String(device_num)+"master"))")
    }
    ...
    override func viewDidLoad() {
        ...
        swipe_view.frame = CGRect(x: 0, y: 0, width: view.frame.width, height: 200)
    ...
    private func setuplayout() {
        ...
        device_label.font = UIFont.boldSystemFont(ofSize: 22)
    ...
    private func labellayout(){
        ...
        brt1label.font = UIFont.systemFont(ofSize:15)
        ...
        cct2label.font = UIFont.systemFont(ofSize:15)
        ...
        ch2label.font = UIFont.systemFont(ofSize:35)
        ...
        brt2label.font = UIFont.systemFont(ofSize:15)
        ...
        ch3label.text = "P3"
        ch3label.font = UIFont.systemFont(ofSize:35)
        ...
        cct3label.font = UIFont.systemFont(ofSize:15)
        ...
        brt3label.font = UIFont.systemFont(ofSize:15)
        ...
        cct4label.font = UIFont.systemFont(ofSize:15)
        ...
        ch4label.font = UIFont.systemFont(ofSize:35)
        ...
        brt4label.font = UIFont.systemFont(ofSize:15)
    ...
    private func sliderlayout(){
        ...
        cctlabel.text = "2800K"
        cctlabel.font = UIFont.systemFont(ofSize: 25)
        ...
        brtlabel.text = "100%"
        brtlabel.font = UIFont.systemFont(ofSize: 25)
        ...
        multi_slider.frame = CGRect(x: (view.frame.size.width/2)-125, y: 250, width: 250, height: 250)
        ...
        multi_day_label.frame = CGRect(x: (view.frame.size.width/2)-75, y: 220+80, width: 150, height: 150)
        ...
        slider.frame = CGRect(x: (view.frame.size.width/2)-150, y: 220, width: 300, height: 350)
        ...
        day_label.frame = CGRect(x: (view.frame.size.width/2)-75, y: 220+100, width: 150, height: 150)
        day_label.text = "100%"
    ...
    private func channellayout(){
        ...
        p1btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:30)
        ...
        p2btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:30)
        ...
        p3btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:30)
        ...
        p4btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:30)
