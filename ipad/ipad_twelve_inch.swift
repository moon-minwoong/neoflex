...
class ipad_twelve_inch: UIViewController{
    ...
    private func labellayout(){
        ...
        let ch_font_size:CGFloat = 90
        let cct_brt_font_size:CGFloat = 42
        ...
        ch1label.font = UIFont.systemFont(ofSize:ch_font_size)
        ...
        cct1label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
        ...
        brt1label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
        ...
        cct2label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
        ...
        ch2label.font = UIFont.systemFont(ofSize:ch_font_size)
        ...
        brt2label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
        ...
        ch3label.text = "P3"
        ch3label.font = UIFont.systemFont(ofSize:ch_font_size)
        ...
        cct3label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
        ...
        brt3label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
        ...
        cct4label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
        ...
        ch4label.font = UIFont.systemFont(ofSize:ch_font_size)
        ...
        brt4label.font = UIFont.systemFont(ofSize:cct_brt_font_size)
    ...
    private func sliderlayout(){
        ...
        let slider_font_size:CGFloat = 70
        cctlabel.translatesAutoresizingMaskIntoConstraints = false
        cctlabel.textColor = .white
        cctlabel.text = "2800K"
        cctlabel.font = UIFont.systemFont(ofSize: slider_font_size)
        cctlabel.centerXAnchor.constraint(equalTo:view.centerXAnchor).isActive = true
        cctlabel.topAnchor.constraint(equalTo:p1btn.bottomAnchor,constant:view.frame.size.height/13).isActive = true
        ...
        brtlabel.text = "100%"
        brtlabel.font = UIFont.systemFont(ofSize: slider_font_size)
        brtlabel.centerXAnchor.constraint(equalTo:view.centerXAnchor).isActive = true
        brtlabel.topAnchor.constraint(equalTo:cctslider.bottomAnchor,constant:65).isActive = true
        ...
        multi_slider.frame = CGRect(x: (view.frame.size.width/2)-275, y: 440, width: 560, height: 560)
        multi_slider.currentValue = (100.0*3)/4
        multi_slider.maximumAngle = 270.0
        multi_slider.lineWidth = 45
        ...
        multi_day_label.frame = CGRect(x: (view.frame.size.width/2)-240, y: 470, width: 500, height: 500)
        multi_day_label.text = "100%"
        multi_day_label.textAlignment = .center
        multi_day_label.textColor = .white
        multi_day_label.font = UIFont.systemFont(ofSize: 120)
        
        
        slider.frame = CGRect(x: (view.frame.size.width/2)-300, y: 450, width: 650, height: 650)
        ...
        day_label.frame = CGRect(x: (view.frame.size.width/2)-220, y: 620, width: 500, height: 300)
        day_label.text = "100%"
        day_label.textAlignment = .center
        day_label.textColor = .white
        day_label.font = UIFont.systemFont(ofSize: 140)
    ...
    private func channellayout(){
        ...
        p1btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:font_size)
        ...
        p2btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:font_size)
        ...
        p3btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:font_size)
        ...
        p4btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:font_size)
    ...
    func setting_preset() {
        ...
        text_preset.font = UIFont.boldSystemFont(ofSize: 45)
        
        cct_preset.translatesAutoresizingMaskIntoConstraints = false
        cct_preset.topAnchor.constraint(equalTo:text_preset.bottomAnchor,constant:60).isActive = true
        ...
        cct_preset.font = UIFont.systemFont(ofSize: 45)
        ...
        brt_preset.topAnchor.constraint(equalTo:cctslider_preset.bottomAnchor,constant:60).isActive = true
        ...
        brt_preset.font = UIFont.systemFont(ofSize: 45)
        ...
        cancel_preset.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:45)
        ...
        ok_preset.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:45)
    ...
    func create_alert(mode:String,stat_textfield:Bool, title:String, title_font:CGFloat, text:String, text_font:CGFloat) {
        ...
        if mode == "Error" {
            ...
            if stat_textfield {
                alert_wifi_name.frame = CGRect(x: alert_text.frame.minX, y: alert_text.frame.maxY+30, width: alert_view.frame.width-alert_text.frame.minX*2, height: 40)
                ...
                alert_wifi_password.frame = CGRect(x: alert_text.frame.minX, y: alert_wifi_name.frame.maxY, width: alert_view.frame.width-alert_text.frame.minX*2, height: 40)
    ...
    @objc func show_info(_ sender:UISwipeGestureRecognizer) {
        ...
        header_of_info.font = UIFont.systemFont(ofSize: 45)
        ...
        subheader_of_info1.frame = CGRect(x: info_background.frame.width/16, y: header_underline.frame.maxY+35, width: info_background.frame.width, height: 0)
        ...
        let subheader_of_info2 = UILabel(frame: CGRect(x: info_background.frame.width/16, y: name_of_hostdimmer.frame.maxY+25, width: info_background.frame.width, height: 0))
    ...
    @objc func enter_device_information(tapGestureRecognizer: UITapGestureRecognizer){
        ...
        let title_font_size:CGFloat = 65
        let title_interval:CGFloat = 110
        let font_size:CGFloat = 50
        let interval:CGFloat = 50
        let slave_font_size:CGFloat = 45
        let line1:CGFloat = 90
        let return_font_size:CGFloat = 60
