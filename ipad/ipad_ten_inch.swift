...
class ipad_ten_inch: UIViewController{
    ...
    private func labellayout(){
        ...
        let ch_font_size:CGFloat = 75
        let cct_brt_font_size:CGFloat = 35
    ...
    private func sliderlayout(){
        ...
        let slider_font_size:CGFloat = 45
        ...
        brtlabel.topAnchor.constraint(equalTo:cctslider.bottomAnchor,constant:45).isActive = true
        ...
        multi_slider.frame = CGRect(x: (view.frame.size.width/2)-200, y: 390, width: 400, height: 400)
        ...
        multi_day_label.frame = CGRect(x: (view.frame.size.width/2)-145, y: 435, width: 300, height: 300)
    ...
    func setting_preset() {
        ...
        text_preset.font = UIFont.boldSystemFont(ofSize: 35)
        ...
        cct_preset.font = UIFont.systemFont(ofSize: 35)
        ...
        brt_preset.font = UIFont.systemFont(ofSize: 35)
        ...
        cancel_preset.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:35)
        ...
        ok_preset.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:35)
    ...
    @objc func enter_device_information(tapGestureRecognizer: UITapGestureRecognizer){
        ...
        let title_font_size:CGFloat = 55
        let title_interval:CGFloat = 90
        let font_size:CGFloat = 40
        let interval:CGFloat = 40
        let slave_font_size:CGFloat = 35
        let line1:CGFloat = 70
