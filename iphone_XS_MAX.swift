...
class iphone_XS_MAX: UIViewController{
    ...
    private func setuplayout() {
        ...
        device_label.font = UIFont.boldSystemFont(ofSize: 26)
    ...
    private func labellayout(){
        ...
        cct1label.leftAnchor.constraint(equalTo:ch1label.rightAnchor, constant: 19).isActive = true
