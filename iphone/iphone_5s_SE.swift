...
class iphone_5s_SE: UIViewController{
    ...
    private func sliderlayout(){
        ...
        cctlabel.text = "2800K"
        cctlabel.font = UIFont.systemFont(ofSize: 23)
        ...
        brtlabel.text = "100%"
        brtlabel.font = UIFont.systemFont(ofSize: 23)
        brtlabel.centerXAnchor.constraint(equalTo:view.centerXAnchor).isActive = true
        brtlabel.topAnchor.constraint(equalTo:cctslider.bottomAnchor,constant:15).isActive = true
        ...
        multi_slider.frame = CGRect(x: (view.frame.size.width/2)-100, y: 220, width: 200, height: 200)
        ...
        multi_day_label.frame = CGRect(x: (view.frame.size.width/2)-72, y: 245, width: 150, height: 150)
        ...
        slider.frame = CGRect(x: (view.frame.size.width/2)-130, y: 210, width: 260, height: 260)
        ...
        day_label.frame = CGRect(x: (view.frame.size.width/2)-75, y: 165+100, width: 150, height: 150)
        day_label.text = "100%"
        day_label.textAlignment = .center
        day_label.textColor = .white
        day_label.font = UIFont.systemFont(ofSize: 55)
    ...
    private func channellayout(){
        ...
        p1btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:28)
        ...
        p2btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:28)
        ...
        p3btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:28)
        ...
        p4btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:28)
 ...
 */
    ...
    @objc func enter_device_information(tapGestureRecognizer: UITapGestureRecognizer){
        ...
        let title_font_size:CGFloat = 30
        let title_interval:CGFloat = 40
        let font_size:CGFloat = 19
        let interval:CGFloat = 17
        let slave_font_size:CGFloat = 15
        let line1:CGFloat = 35
        let return_font_size:CGFloat = 25
