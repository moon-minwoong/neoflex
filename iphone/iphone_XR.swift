...
class iphone_XR: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        swipe_view.frame = CGRect(x: 0, y: 0, width: view.frame.width, height: 330)
    ...
    private func setuplayout() {
        ...
        device_label.topAnchor.constraint(equalTo:view.safeAreaLayoutGuide.topAnchor, constant: view.frame.height/40+10.5).isActive = true
    ...
    private func labellayout(){
        ...
        brt1label.font = UIFont.systemFont(ofSize:20)
        ...
        cct2label.font = UIFont.systemFont(ofSize:20)
        ...
        ch2label.font = UIFont.systemFont(ofSize:50)
        ...
        brt2label.font = UIFont.systemFont(ofSize:20)
        ...
        ch3label.text = "P3"
        ch3label.font = UIFont.systemFont(ofSize:50)
        ...
        cct3label.font = UIFont.systemFont(ofSize:20)
        ...
        brt3label.font = UIFont.systemFont(ofSize:20)
        ...
        cct4label.font = UIFont.systemFont(ofSize:20)
        ...
        ch4label.font = UIFont.systemFont(ofSize:50)
        ...
        brt4label.font = UIFont.systemFont(ofSize:20)
    ...
    private func sliderlayout(){
        ...
        cctlabel.text = "2800K"
        cctlabel.font = UIFont.systemFont(ofSize: 32)
        cctlabel.centerXAnchor.constraint(equalTo:view.centerXAnchor).isActive = true
        cctlabel.topAnchor.constraint(equalTo:p1btn.bottomAnchor,constant:view.frame.size.height/14).isActive = true
        ...
        brtlabel.text = "100%"
        brtlabel.font = UIFont.systemFont(ofSize: 32)
        ...
        multi_slider.frame = CGRect(x: (view.frame.size.width/2)-140, y: 360, width: 280, height: 280)
        multi_slider.currentValue = (100.0*3)/4
        multi_slider.maximumAngle = 270.0
        multi_slider.lineWidth = 25
        ...
        multi_day_label.frame = CGRect(x: (view.frame.size.width/2)-73, y: 345+80, width: 150, height: 150)
        multi_day_label.text = "100%"
        multi_day_label.textAlignment = .center
        multi_day_label.textColor = .white
        multi_day_label.font = UIFont.systemFont(ofSize: 50)
        
        
        slider.frame = CGRect(x: (view.frame.size.width/2)-175, y: 340, width: 350, height: 350)
        ...
        day_label.frame = CGRect(x: (view.frame.size.width/2)-95, y: 315+100, width: 200, height: 200)
        day_label.text = "100%"
        day_label.textAlignment = .center
        day_label.textColor = .white
        day_label.font = UIFont.systemFont(ofSize: 65)
    ...
    private func channellayout(){
        ...
        p1btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:36)
        ...
        p2btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:36)
        ...
        p3btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:36)
        ...
        p4btn.titleLabel?.font=UIFont(name:"HelveticaNeue-Bold",size:36)
 ...
 */
    ...
    @objc func show_info(_ sender:UISwipeGestureRecognizer) {
        ...
        let header_of_info = UILabel(frame: CGRect(x: 0, y: info_background.frame.height/12, width: info_background.frame.width, height: 0))
    ...
    @objc func enter_device_information(tapGestureRecognizer: UITapGestureRecognizer){
        ...
        let title_font_size:CGFloat = 36
        let title_interval:CGFloat = 60
        let font_size:CGFloat = 25
        let interval:CGFloat = 25
        let slave_font_size:CGFloat = 22
        let line1:CGFloat = 50
        let return_font_size:CGFloat = 35
