...
class iphone_X: UIViewController{
    ...
    private func setuplayout() {
        ...
        device_label.topAnchor.constraint(equalTo:view.safeAreaLayoutGuide.topAnchor, constant: view.frame.height/40+9.5).isActive = true
    ...
    private func labellayout(){
        ...
        ch1label.font = UIFont.systemFont(ofSize:40)
        ...
        cct1label.font = UIFont.systemFont(ofSize:17)
        ...
        brt1label.font = UIFont.systemFont(ofSize:17)
        ...
        cct2label.font = UIFont.systemFont(ofSize:17)
        ...
        ch2label.font = UIFont.systemFont(ofSize:40)
        ...
        brt2label.font = UIFont.systemFont(ofSize:17)
        ...
        ch3label.text = "P3"
        ch3label.font = UIFont.systemFont(ofSize:40)
        ...
        cct3label.font = UIFont.systemFont(ofSize:17)
        ...
        brt3label.font = UIFont.systemFont(ofSize:17)
        ...
        cct4label.font = UIFont.systemFont(ofSize:17)
        ...
        ch4label.font = UIFont.systemFont(ofSize:40)
        ...
        brt4label.font = UIFont.systemFont(ofSize:17)
    ...
    private func sliderlayout(){
        ...
        multi_slider.frame = CGRect(x: (view.frame.size.width/2)-125, y: 330, width: 250, height: 250)
        ...
        multi_day_label.frame = CGRect(x: (view.frame.size.width/2)-75, y: 300+80, width: 150, height: 150)
        ...
        slider.frame = CGRect(x: (view.frame.size.width/2)-150, y: 320, width: 300, height: 350)
        ...
        day_label.frame = CGRect(x: (view.frame.size.width/2)-75, y: 320+100, width: 150, height: 150)
        day_label.text = "100%"
    ...
    @objc func show_info(_ sender:UISwipeGestureRecognizer) {
        ...
        let header_of_info = UILabel(frame: CGRect(x: 0, y: info_background.frame.height/10, width: info_background.frame.width, height: 0))
